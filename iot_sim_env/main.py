...
# Start traffic generation with tracker
env.process(traffic_generator(env, node_A, node_B, size_choice=0, tracker=tracker))
env.process(traffic_generator(env, node_B, node_C, size_choice=1, tracker=tracker))
...
print(f"\nAverage transit time: {final_stats['avg_transit_time']:.6f} seconds")
